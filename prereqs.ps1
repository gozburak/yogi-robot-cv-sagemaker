...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2h8id2qn57my5-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert GreengrassQuickStartCore-1845c43773b.cert.pem --key GreengrassQuickStartCore-1845c43773b.private.key --client_id basicPubSub --topic sdk/test/Python --count 0